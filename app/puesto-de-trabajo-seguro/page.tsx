...
const faqs = [
  {
    question: '¿Qué Mac puedo conseguir con el Kit Digital?',
    highlight: 'Mac',
    answer: 'Dependiendo del bono disponible y del stock, podemos asignarte un MacBook Air M2/M3 o un Mac mini. El modelo exacto se confirma tras verificar tu segmento.',
  },
  {
    question: '¿Hay opción de PC Windows?',
    highlight: 'PC Windows',
    answer: 'Sí. Disponemos de portátiles y sobremesas Windows (Intel Core i5/i7 o AMD Ryzen) con Windows 11 Pro y el mismo stack de ciberseguridad empresarial.',
  },
  {
    question: '¿Qué incluye el EDR?',
    highlight: 'EDR',
    answer: 'El EDR (Endpoint Detection & Response) incluye: antivirus de próxima generación, detección de comportamiento anómalo en tiempo real, políticas de firewall, y alertas ante ransomware y malware avanzado.',
  },
  {
    question: '¿Cuánto tarda el proceso?',
    highlight: 'tarda',
    answer: 'Una vez aprobado el bono por Red.es (entre 4 y 12 semanas), el despliegue del hardware se realiza en 5–10 días laborables.',
  },
  {
    question: '¿Tengo que hacer llamadas o reuniones?',
    highlight: 'llamadas',
    answer: 'No. Todo el proceso es 100% digital y asíncrono. Las firmas son electrónicas y la verificación de documentación se realiza vía formulario seguro.',
  },
  {
    question: '¿Qué pasa si el equipo que quiero cuesta más de 1.000€?',
    highlight: '1.000€',
    answer: 'El bono cubre hasta 1.000€ (Segmento III). Si eliges un modelo con precio superior, únicamente abonas la diferencia. Te lo detallamos por escrito antes de firmar nada.',
  },
  {
    question: '¿Quién tramita el expediente ante el Gobierno?',
    highlight: 'expediente',
    answer: 'ZephyrStudio, como Agente Digitalizador Adherido al programa Kit Digital, actúa como tu representante voluntario y gestiona todo el expediente ante Red.es.',
  },
  {
    question: '¿El soporte está incluido?',
    highlight: 'soporte',
    answer: 'Sí. El programa incluye 12 meses de soporte técnico por parte del Agente Digitalizador, incluyendo incidencias de software y actualizaciones de seguridad.',
  },
]
...
export default function PuestoTrabajoPage() {
  return (
    <>
      ...
      {/* No overflow-x-hidden here — it breaks position:sticky inside ProcessSteps */}
      <div className="relative min-h-screen">
        ...
        {/* ── 4. PROCESS STEPS (stacking sticky cards) ────────────── */}
        <ProcessSteps />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white/[0.02] backdrop-blur-xl border border-[#00e5ff]/20 rounded-3xl p-10 shadow-[0_0_60px_rgba(0,229,255,0.06)]">
              ...
              <ul className="space-y-5">
                {[
                  'Hasta 1.000€ subvencionados por el Bono Kit Digital.',
                  'Si eliges un equipo superior, pagas solo la diferencia. Sin sorpresas.',
                  'Te lo dejamos por escrito antes de firmar. Sin compromisos previos.',
                  'Desglose por escrito antes de firmar nada.',
                ].map((text, idx) => (
        ...
        <section className="py-24 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-10">
              {[
                { seg: 'Segmento III', range: '0 – 2 empleados', bono: 'Hasta 1.000€', color: 'border-[#00e5ff]/30', badge: 'bg-[#00e5ff]/10 text-[#00e5ff] border-[#00e5ff]/20' },
                { seg: 'Segmento II', range: '3 – 9 empleados', bono: 'Consultar limite aplicable', color: 'border-[#0018d8]/30', badge: 'bg-[#0018d8]/10 text-slate-300 border-[#0018d8]/30' },
              ].map((s, idx) => (
                <article key={idx} className={`bg-white/[0.02] backdrop-blur-xl border ${s.color} rounded-3xl p-8`}>
                  <span className={`inline-block text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full border ${s.badge} mb-5`}>{s.seg}</span>
            ...
            <div className="text-center">
              <Link href="/wizard" className="inline-flex items-center gap-2 px-7 py-3.5 bg-white/[0.04] border border-white/10 hover:border-[#00e5ff]/40 rounded-2xl text-white font-semibold text-sm transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={idx} className="flex flex-col gap-2 bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl p-5 hover:border-[#00e5ff]/20 transition-all duration-300">
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="w-full">
                ...
                {reviews.map((review, idx) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">{review.role} &middot; {review.company}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
              ...
              <div className="flex items-center justify-center gap-3 mt-5 md:hidden">
                {reviews.map((_, idx) => (
                  <span key={idx} className={`block rounded-full transition-all duration-300 ${idx === 0 ? 'w-5 h-1.5 bg-[#00e5ff]' : 'w-1.5 h-1.5 bg-white/20'}`} />
                ))}
        ...
        <section className="py-24 md:py-36 px-4 text-center relative">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-slate-400 font-light mb-10 text-lg">Sin llamadas. Sin burocracia manual. Solo resultados.</p>
            <Link
              href="/wizard"
